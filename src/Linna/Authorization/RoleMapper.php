...
class RoleMapper extends MapperAbstract implements RoleMapperInterface
{
     ...
     * {@inheritdoc}
     */
    public function grantPermissionById(Role &$role, string|int $permissionId)
    {
        $roleId = $role->getId();
     ...
     * {@inheritdoc}
     */
    public function revokePermissionById(Role &$role, string|int $permissionId)
    {
        $roleId = $role->getId();
     ...
     * {@inheritdoc}
     */
    public function addUserById(Role &$role, string|int $userId)
    {
        $roleId = $role->getId();
     ...
     * {@inheritdoc}
     */
    public function removeUserById(Role &$role, string|int $userId)
    {
        $roleId = $role->getId();
